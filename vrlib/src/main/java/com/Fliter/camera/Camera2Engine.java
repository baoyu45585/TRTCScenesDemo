...
public class Camera2Engine extends CameraImpl {
     ...
     */
    private static final int MAX_PREVIEW_WIDTH = PatRecordConstant.PatRecordParamsType.HEIGHT;

    /**
     * Max preview height that is guaranteed by Camera2 API
     */
    private static final int MAX_PREVIEW_HEIGHT = PatRecordConstant.PatRecordParamsType.WIDTH;
