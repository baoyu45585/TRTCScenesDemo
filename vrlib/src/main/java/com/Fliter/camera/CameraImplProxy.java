...
//        stopSensor();
    ...
    public boolean isFlipHorizontal() {
        ...
        return mImpl.getFacing() == CameraInfo.CAMERA_FACING_FRONT ? true : false;
    }
...
//            requestLayout();
    ...
    public void onFocus(Point point, final CameraDisplayDoubleInput.OnFocusListener listener) {
        if (mImpl != null) {
            mImpl.onFocus(point, new CameraImpl.AutoFocusCallback() {
                @Override
                public void onAutoFocus(boolean success) {
