...
public class MD360Program {
    ...
    protected String getVertexShader(Context context){
        return readTextFileFromRaw(context, R.raw.vr_per_pixel_vertex_shader);
    }
        ...
        static String fs(Context context, int type){
            ...
            switch (type){
                case MDVRLibrary.ContentType.BITMAP:
                    resId = R.raw.vr_per_pixel_fragment_shader_bitmap;
                    break;
                case MDVRLibrary.ContentType.FBO:
                    resId = R.raw.vr_per_pixel_fragment_shader_bitmap_fbo;
                    break;
                case MDVRLibrary.ContentType.CUBEMAP:
                    resId = R.raw.vr_per_pixel_fragment_shader_cubemap;
                    break;
                case MDVRLibrary.ContentType.VIDEO:
                default:
                    resId = R.raw.vr_per_pixel_fragment_shader;
                    break;
            }
